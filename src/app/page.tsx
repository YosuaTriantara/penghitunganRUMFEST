...
export default function TeamPointsChart() {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        result.values.slice(1).forEach(([, team, Tingkat, , totalPoints]: string[]) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 p-6 space-y-8">
      <h1 className="text-3xl font-bold text-gray-800">Perolehan Nilai Supporter RUMFESTIVAL VI</h1>
